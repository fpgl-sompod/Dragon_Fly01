    ...
    .defines(function () {
        EntityGameControl = ig.Entity.extend({
            ...
            EndlessBg: function () { //this is for moving background
                ...
                if (this.isBgMovingport == 1) {
                    this.isBgMovingport = 0;
                    this.tween({ bgPortX: -600 }, this.timeport, {
                        onComplete: function () {
                            this.bgPortX = 2950;
                            this.timeport = 6;
                            this.isBgMovingport = 1;

                        }.bind(this)
                    }).start();
                }
                if (this.isBgMoving1port == 1) {
                    this.isBgMoving1port = 0;
                    this.tween({ bgPortX1: -600 }, this.time1port, {
                        onComplete: function () {
                            this.bgPortX1 = 2950;
                            this.time1port = 6;
                            this.isBgMoving1port = 1;
                        }.bind(this)
                    }).start();
                }
                if (this.isBgMoving2port == 1) {
                    this.isBgMoving2port = 0;
                    this.tween({ bgPortX2: -600 }, this.time2port, {
                        onComplete: function () {
                            this.bgPortX2 = 2950;
                            this.time2port = 6;
                            this.isBgMoving2port = 1;
                        }.bind(this)
                    }).start();
                }

                // those code for landscape
                if (this.isBgMovingland == 1) {
                    this.isBgMovingland = 0;
                    this.tween({ bgLandscapeX: -460 }, this.timeland, {
                        onComplete: function () {
                            this.bgLandscapeX = 2380;
                            this.timeland = 6;
                            this.isBgMovingland = 1;

                        }.bind(this)
                    }).start();
                }
                if (this.isBgMoving1land == 1) {
                    this.isBgMoving1land = 0;
                    this.tween({ bgLandscapeX1: -460 }, this.time1land, {
                        onComplete: function () {
                            this.bgLandscapeX1 = 2380;
                            this.time1land = 6;
                            this.isBgMoving1land = 1;
                        }.bind(this)
                    }).start();
                }
                if (this.isBgMoving2land == 1) {
                    this.isBgMoving2land = 0;
                    this.tween({ bgLandscapeX2: -460 }, this.time2land, {
                        onComplete: function () {
                            this.bgLandscapeX2 = 2380;
                            this.time2land = 6;
                            this.isBgMoving2land = 1;
                        }.bind(this)
                    }).start();
                }
